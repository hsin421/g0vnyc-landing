          ...
          <Row className={styles.speakerBio}>
            ...
            <Col lg="6" lg-offset="0" md="8" md-offset="2" xs="12" className={styles.speakerDetail}>
              ...
              <h4 className={styles.speakerSubtitle}>自由軟體工作者、公民記者</h4>
                ...
                中山大學生科系畢業，研究所主要專研動物生理學研究，同時開始自學程式，並參與撰寫 Lazyscript 專案。由於撰寫程式的經驗，因此有機會到中國擔任四年的工程師；但卻因為看見中國政府統治的荒謬而開始針對時事撰寫文章，希望能讓台灣看清獨裁體制的問題。後來加入沃草團隊，在立法院擔任國會記者以及沃草專案經理。在過去台灣 g0v 黑客松活動中，林雨蒼是積極的行動者，他參與 g0v 的許多專案，以及研究政策，為公開透明盡一份心力。 目前雨蒼卸下民間司法改革基金會的工作，擔任台灣不當黨產委員會委員，透過其資訊科技與司法政策的專長，為開放政府與公平正義的理想打拼。
               </p>
          	</Col>
          </Row>
          <Row>
          ...
          <Row className={styles.speakerBio}>
            ...
            <Col lg="6" lg-offset="0" md="8" md-offset="2" xs="12" className={styles.speakerDetail}>
              ...
              <p className={styles.staffCardBodyText}>
                ...
                Vincent 共同經營 BestPractical 公司。2013 年底協助台灣學研界推廣自由開源軟體人才培育計畫。高嘉良是 Subversion 為版本控制系統 SVK 之創始者。他也是 Xcin 輸入法框架的前開發者以及 ChewingOSX / 酷音輸入法作者。在 2012 年，高嘉良與唐鳳等人共同發起零時政府，以開源軟體推動開放資料及開放政府運動。投入開放國會、中央政府總預算視覺化等專案。在台灣的公民社會與科技的結合發展中，扮演關鍵的角色。
               </p>
            </Col>
          </Row>
          <Row>
